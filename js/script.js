...
const sentences = [
  ...
  "Делаем сайты удобные для пользователей",
  "Адаптируем под телефоны, планшеты и ПК",
  "Оптимизируем изображения для быстрой загрузки",
  "Улучшаем текста для поисковых систем",
  "Помогаем с выбором сервера и домена",
];
